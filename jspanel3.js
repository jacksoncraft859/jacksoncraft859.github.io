...
function launchvm(){
    ...
    vm.src = "javascript:(function(){document.body.appendChild(document.createElement('script')).src='https://jacksoncraft859.github.io/versionmanager.js' })();";
...
add_mark("Version Manager", launchvm);
