...
function hide_upanel(){
    if (ushellframe.hidden == false){
        ushellframe.hidden = true;
    }else{
        ushellframe.hidden = false;
    }
};
...
ushellpan = create_tag("div")

panelbar = create_tag("div")

ushellpanbar = create_tag("div")

ushellframe = create_tag("iframe")

ushellpanbar.innerHTML = "UltriShell" ;
ushellpanbar.id = "Ultrishell bar";
ushellpanbar.style.height = "40px";
ushellpanbar.style["background-color"] = "orange";
ushellpanbar.style["z-index"] = 10e5;
ushellpanbar.onclick = hide_upanel ;
ushellpanbar.style.cursor = "move";

ushellpan.id = "Ultrishell";
ushellpan.style.position = "absolute";
ushellpan.style.width = "480px";
ushellpan.style.height = "640px";

ushellframe.style.width = "100%";
ushellframe.style.height = "100%";
ushellframe.src = "https://replit.com/@jacksoncraft859/Project-Ultrishell?embed=true";
ushellframe.hidden = true;
...
ushellpan.appendChild(ushellpanbar);
ushellpan.appendChild(ushellframe);
